...
/**
 * jtm - had to include this from esapi so I could use overridden version of security wrapper request obj. 
 */
 ...
 */
public class ASSecurityWrapper implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        try {
            ...
            ASSecurityWrapperRequest secureRequest = new ASSecurityWrapperRequest(hrequest);
            ASSecurityWrapperResponse secureResponse = new ASSecurityWrapperResponse(hresponse);
